...
benchmark_info = {
    "mbench": {"title": "Alloc", "unit": 1000000, "unittype": "M"},
    "mfmbench": {"title": "Alloc + Fault + Modify", "unit": 1000, "unittype": "K"},
    "f_mbench": {"title": "Alloc", "unit": 1000000, "unittype": "M"},
    "f_mfmbench": {"title": "Alloc + Fault + Modify", "unit": 1000, "unittype": "K"},
}
...
def draw_one(benchtype, output_name, data, cpu_count=32):
