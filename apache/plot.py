...
version_info = {
    ...
    "6.8.0-interval-vm-debug+_no_fault": {"label": "LinuxOurs w/o Fault", "linestyle": "dotted", "marker": "+", "color": "navy"},
    "6.8.0-interval-vm-debug+_no_alloc": {"label": "LinuxOurs w/o Alloc", "linestyle": "dashed", "marker": "o", "color": "dodgerblue"},
    "6.8.0-interval-vm-debug+_no_modify": {"label": "LinuxOurs w/o Modify", "linestyle": "dashdot", "marker": "d", "color": "skyblue"},
...
def draw(output_name, data, cpu_count=48):
    ...
    plt.ylabel("Throughput (" + benchunittype + " req/s)", fontsize=label_size)
